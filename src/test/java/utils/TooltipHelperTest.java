...
public class TooltipHelperTest {
    ...
    void testEnableTooltipOnDisabled() {
        testsupport.TestLog.out("🧪 Testing tooltip enabling on disabled components...");
        ...
        testsupport.TestLog.out("✅ Tooltip enabling on disabled components works correctly");
    }

    @Test
    void testTooltipOnEnabledComponent() {
        testsupport.TestLog.out("🧪 Testing tooltip behavior on enabled components...");
        ...
        testsupport.TestLog.out("✅ Tooltip behavior on enabled components works correctly");
    }

    @Test
    void testNullComponentHandling() {
        testsupport.TestLog.out("🧪 Testing null component handling...");
        ...
        testsupport.TestLog.out("✅ Null component handling works gracefully");
    }

    @Test
    void testNullTooltipTextHandling() {
        testsupport.TestLog.out("🧪 Testing null tooltip text handling...");
        ...
        testsupport.TestLog.out("✅ Null tooltip text handling works correctly");
    }

    @Test
    void testEmptyTooltipTextHandling() {
        testsupport.TestLog.out("🧪 Testing empty tooltip text handling...");
        ...
        testsupport.TestLog.out("✅ Empty tooltip text handling works correctly");
    }

    @Test
    void testMultipleTooltipEnabling() {
        testsupport.TestLog.out("🧪 Testing multiple tooltip enabling calls...");
        ...
        testsupport.TestLog.out("✅ Multiple tooltip enabling calls handled correctly");
    }

    @Test
    void testTooltipManagerInteraction() {
        testsupport.TestLog.out("🧪 Testing ToolTipManager interaction...");
        ...
        testsupport.TestLog.out("✅ ToolTipManager interaction works correctly");
    }

    @Test
    void testComponentTypeCompatibility() {
        testsupport.TestLog.out("🧪 Testing component type compatibility...");
        ...
        testsupport.TestLog.out("✅ Component type compatibility works correctly");
    }

    @Test
    void testHeadlessEnvironmentHandling() {
        testsupport.TestLog.out("🧪 Testing headless environment handling...");
        ...
        if (GraphicsEnvironment.isHeadless()) {
            ...
            testsupport.TestLog.out("Running in headless environment - GUI tests skipped");
        } else {
        ...
        testsupport.TestLog.out("✅ Headless environment handling works correctly");
    }
}