...
jar cvfm loghog-test.jar manifest.txt main/LogTextEditor.class gui/*.class filehandling/*.class clipboard/*.class browser/*.class encryption/*.class markdown/*.class main/*.class utils/*.class resources/
