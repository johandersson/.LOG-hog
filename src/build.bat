...
jar cvfm "%~dp0build\%JAR_NAME%" manifest.txt LogHog.class main/LogTextEditor.class gui/*.class filehandling/*.class clipboard/*.class browser/*.class encryption/*.class security/*.class markdown/*.class main/*.class services/*.class utils/*.class -C .. LICENSE.md resources/ *.txt resources/*
if %errorlevel% neq 0 (
    popd
